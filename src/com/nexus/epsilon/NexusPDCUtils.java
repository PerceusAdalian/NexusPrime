...
{
	/**
	 * @Documentation: This class is not monitored nor used in any child classes yet. Further analysis required before mounting into @main --> This class was provided by a friend/fellow programmer. 
	 */
	
	private static NamespacedKey dataKey = new NamespacedKey(NexusProper.instance,"JSON_DATA_MAP");
	...
	public static boolean has(String key,PersistentDataHolder dataHolder)
	{
		...
		NamespacedKey NSKey = new NamespacedKey(NexusProper.instance,key);
...
//		}
	 ...
	 */
	public static NexusPDCValues get(String key,ItemStack stack)
	{
	 ...
	 * @return DataContainerValue
	 */
	public static NexusPDCValues get(String key,PersistentDataHolder dataHolder)
	{
		PersistentDataContainer data = dataHolder.getPersistentDataContainer();
		return new NexusPDCValues(key,data);
	}
